...
const Popular = ({ url, mediaType, setClicked }: { url: string, mediaType: string, setClicked: Dispatch<SetStateAction<Clicked>> }) => {
    ...
    const { data, loading } = useAxios<InitialState, { page: number }>(url, {} as InitialState, { page: pageNum }, pageNum);
        ...
        <div>
            {
                !loading ? (
                    <div className='data-container'>
                        { mediaType === 'movie' ? <h2>Popular Movies</h2> : <h2>Popular TV Shows</h2> }
