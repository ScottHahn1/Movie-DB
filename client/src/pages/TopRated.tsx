...
const TopRated = ({ url, mediaType, setClicked }: { url: string, mediaType: string, setClicked: Dispatch<SetStateAction<Clicked>> }) => {
        ...
        <div>
            {
                !loading ? (
                    <div className='data-container'>
                        { mediaType === 'movie' ? <h2>Top Rated Movies</h2> : <h2>Top Rated TV Shows</h2> }
